...
public class PoiSearchActivity extends FragmentActivity implements OnGetPoiSearchResultListener, OnGetSuggestionResultListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        city1 = MainActivity.city;
        searchkey1 = MainActivity.searchthing;
        ...
        keyWorldsView = (TextView)findViewById(R.id.searchkey);
        sugAdapter = new ArrayAdapter<String>(this,
                android.R.layout.simple_dropdown_item_1line);
       /* keyWorldsView.setAdapter(sugAdapter);
        keyWorldsView.setThreshold(1);*/
        keyWorldsView.setText(searchkey1);
        mBaiduMap = ((SupportMapFragment) (getSupportFragmentManager()
                .findFragmentById(R.id.map))).getBaiduMap();
        sss(city1, searchkey1);
        /**
         * 当输入关键字变化时，动态更新建议列表
         */
            ...
            public void onTextChanged(CharSequence cs, int arg1, int arg2,
                ...
                mSuggestionSearch
                        .requestSuggestion((new SuggestionSearchOption())
                                .keyword(cs.toString()).city(MainActivity.city.toString()));
            }
        });
    ...
    public String sss(String city1 , String searchkey1) {
        searchType = 1;
        String citystr =city1;
        String keystr = searchkey1;
